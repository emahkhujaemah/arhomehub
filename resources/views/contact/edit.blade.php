...
<div class="row">
    ...
    <form style="margin-left:20px;width:96%;" action="{{ route('contact.update',$contact->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Phone:</strong>
                <input type="phone" name="phone" value="{{ $contact->phone }}" class="form-control" placeholder="Phone">
            </div>
        </div>
